...
from logger import setup_logging, ColoredLogger
...
class ConfigParser:
    def __init__(self, args, options='', timestamp=True):
        ...
        self._output_dir = save_dir / 'generated' / exper_name / timestamp
    ...
    def initialize(self, name, module, type=None, *args, **kwargs):
        """
        finds a function handle with the name given as 'type' in config, and returns the
        instance initialized with corresponding keyword args given as 'args'.
        """
        if type:
            module_name = self[type][name]['type']
            module_args = dict(self[type][name]['args'])
        else:
